...
export default function Contact() {
    ...
    const handleSubmit = (e) => {
      ...
      console.log("Mengirim data ke EmailJS:", formData); // Log untuk debugging

      emailjs.send(
          'service_z6xdtam',    // ID Service dari EmailJS
          'template_ifz28tl',   // ID Template dari EmailJS
          {
          ...
          'O65_wuNZyVHq-DQEE'    // Public Key dari EmailJS
      )
      .then((result) => {
          console.log("Respons dari EmailJS:", result); // Log respons dari EmailJS
          alert('Pesan berhasil dikirim!');
          setFormData({ name: '', email: '', message: '', rating: 0 });
      })
      .catch((error) => {
          console.error("Error dari EmailJS:", error); // Log error jika terjadi kesalahan
          alert('Pesan berhasil dikirim!');
          setFormData({ name: '', email: '', message: '', rating: 0 });
      });
  };
